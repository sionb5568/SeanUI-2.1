...
def main():
    ...
    background_image_path = "file (6) (1).png"
    user_image_path = "11zon_cropped.png"
    logo_image_path = "free-icon-user-3177440.png"
    font_path = None
...
def draw_ui(screen):
    ...
    logo_image = pygame.image.load("free-icon-user-3177440.png")
    logo_image = pygame.transform.scale(logo_image, (30, 30))
    screen.blit(logo_image, (10, 5))
...
class App:
    ...
    def load_icon_image(self):
        if self.name == "SeanUI":
            icon_path = "Untitled25_20230608195827.PNG"
        elif self.name == "Weather":
            icon_path = "무제67_20240619163216.PNG"
        elif self.name == "Google":
            icon_path = "file111 복사본.png"
            icon_path = "file111 복사본.png"
        elif self.name == "Clock":
            icon_path = "무제68_20240619205736 2.PNG"
        elif self.name == "Calculator":
            icon_path = "무제67_20240619162149.PNG"
        elif self.name == "Notes":
            icon_path = "스크린샷 2024-06-22 오후 7.35.31.png"
        elif self.name == "Drawing":
            icon_path = "IMG_8516.png"
...
def create_apps(app_count, bottom_bar_rect):
    ...
    for i in range(app_count):
        ...
        if i == 0:
            ...
            app = App("Google", app_rect, _position, color=(255, 255, 255))
        elif i == 3:
