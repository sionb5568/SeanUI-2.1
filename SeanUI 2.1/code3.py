    ...
    if current_time - last_update_time > update_interval:
        ...
        if "response" in weather_data and "body" in weather_data["response"] and "items" in weather_data["response"]["body"]:
            ...
            if 'PTY' in weather_dict:
                pty = int(weather_dict['PTY'])
                if pty == 0:
                    small_window_image_path = 'sky.png'  # sunny
                elif pty == 1:
                    small_window_image_path = '스크린샷 2024-06-22 오후 7.39.38.png'  #rain
                elif pty == 2:
                    small_window_image_path = '날씨 눈.png'  # snow
                else:
                    small_window_image_path = '스크린샷 2024-06-22 오후 7.39.52.png'  # cloudy
            else:
                small_window_image_path = 'sky.png'  # normal
